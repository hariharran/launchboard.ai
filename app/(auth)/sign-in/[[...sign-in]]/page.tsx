...
export default function SignInPage() {
  return (
    <AuthShell
      ...
      title="Sign in and keep building."
      description="Pick up where you left off, review saved projects, and jump back into your generator workspace."
    >
      {hasClerkPublicEnv ? (
        <>
          <ClerkLoading>
        ...
        <div className="rounded-[24px] border border-amber-200 bg-amber-50 p-6 text-sm leading-7 text-amber-950">
          Add your Clerk publishable and secret keys to your local environment to enable the sign-in flow.
        </div>
      )}
    </AuthShell>
  );
